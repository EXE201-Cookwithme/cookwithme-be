...
export class PaymentController {
    ...
    async getPaymentLinkInformation(@Res() res: Response) {
        try {
            const paymentLinkResponse = await this.paymentService.getPaymentLinkInformation('id');
            res.json(paymentLinkResponse);
        } catch (error) {
    ...
    async cancelPaymentLink(@Res() res: Response) {
        try {
            const paymentLinkResponse = await this.paymentService.cancelPaymentLink('id');
            res.json(paymentLinkResponse);
        } catch (error) {
